...
namespace PRISMS
{
    ...
    namespace PLibrary
    {
        ...
        void checkout( std::string name, PSimpleFunction< double*, double > &simplefunc);
        void checkout( std::string name, PSimpleFunction< std::vector<double>, bool > &simplefunc);
        void checkout( std::string name, PSimpleFunction< double*, bool > &simplefunc);
        ...
        void checkout( std::string name, PSimpleBase< double*, double > *&simplefunc);
        void checkout( std::string name, PSimpleBase< std::vector<double>, bool > *&simplefunc);
        void checkout( std::string name, PSimpleBase< double*, bool > *&simplefunc);
        ...
        void checkout( std::string name, PPieceWiseFuncBase< std::vector<double>, double > *&func);
        void checkout( std::string name, PPieceWiseFuncBase< double*, double > *&func);

        void checkout( std::string name, PBasisSetBase< double, double > *&basis_set, int N);
    }
